...
class _AdminMemberManagementScreenState
  ...
  Future<void> _loadMembers() async {
    ...
    try {
      ...
      if (familyId == null) { _showError('Family not found'); return; }
  ...
  void _showAddMemberDialog() {
    ...
    final phoneCtrl = TextEditingController(); // ← NEW: member's phone
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  helperText:
                      'Member will use this number to log in for the first time',
  ...
  Future<void> _addMember(
    ...
    if (name.isEmpty) { _showError('Please enter member name'); return; }
    if (ageText.isEmpty) { _showError('Please enter age'); return; }
    ...
    try {
      await _firestoreService.addFamilyMember(
        ...
        phone: normalizedPhone, // ← passed through to Firestore
      );
  ...
  Future<void> _confirmDeleteMember(FamilyMember member) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
          'This will permanently delete all their health data.',
