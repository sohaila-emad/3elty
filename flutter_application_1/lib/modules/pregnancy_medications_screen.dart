...
class _PregnancyMedicationsScreenState
  ...
  String get _todayLabel {
    ...
    return 'الأحد ${now.day} ${_months[now.month]}';
  }
        ...
        builder: (_, setS) => Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              // تم التعديل هنا لوضع الـ Decoration داخل TextField
              TextField(
                controller: nameCtrl,
                decoration: _field('اسم الدواء', 'مثال: حمض الفوليك'),
              ),
              const SizedBox(height: 14),
              // السطر 133
 // السطر 136 في الصورة (اسم الدواء)
              TextField(
                controller: nameCtrl,
                decoration: _field('اسم الدواء', 'مثال: حمض الفوليك'), // شيلي nameCtrl من هنا
              ), 

              // السطر 143 في الصورة (الجرعة)
              TextField(
                controller: doseCtrl,
                decoration: _field('الجرعة', 'مثال: ٥ مجم'), // شيلي doseCtrl من هنا
              ),
              const SizedBox(height: 14),
              ...
              Wrap(
                spacing: 8,
                children: ['الصباح', 'الظهر', 'المساء', 'الليل'].map((t) {
                  return FilterChip(
                    label: Text(t),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    if (nameCtrl.text.isEmpty || doseCtrl.text.isEmpty ||
  ...
  // تعديل الدالة لترجع فقط الـ Decoration
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      if (_medications.isEmpty)
                        ...
                        ..._medications.map((med) => _MedCard(
                              med: med,
                              confirmed: med.id != null &&
                                  _confirmState.isConfirmed(med.id!),
                              onConfirm: () {
                                if (med.id != null) {
                                  setState(() =>
                                      _confirmState.confirm(med.id!));
                                }
                              },
                            )),
        ...
        children: [
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              backgroundColor: AppColors.grey100,
              valueColor:
                  const AlwaysStoppedAnimation<Color>(Color(0xFFAD1457)),
            ),
          ),
          const SizedBox(height: 8),
          const Text(
            'لقد أكملت معظم جرعاتك هذا الأسبوع، حافظي على هذا المستوى!',
