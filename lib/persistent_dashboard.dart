              ...
              if (snapshot.data == 'admin') {
                return IconButton(
                  ...
                  onPressed: () => Navigator.of(context)
                      ...
                      // Reload the member list whenever the admin screen is popped,
                      // so additions/deletions are reflected immediately.
                      .then((_) { if (mounted) _loadMembers(); }),
                );
              }
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  ...
                  // formatMemberAge handles child (stored in months) vs other profiles (years)
                  Text(formatMemberAge(member),
