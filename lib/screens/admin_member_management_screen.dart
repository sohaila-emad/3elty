...
class _AdminMemberManagementScreenState
  ...
  Future<void> _showAddMemberSheet() async {
    ...
    final phoneCtrl = TextEditingController(); // رقم تليفون العضو
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    labelText: 'رقم تليفون العضو',
                    hintText: '1XXXXXXXXX',
                    helperText: 'العضو هيستخدمه عشان يدخل التطبيق لأول مرة',
                    helperStyle: const TextStyle(fontSize: 12, color: AppColors.grey600),
                    prefixText: '+20  ',
                    prefixStyle: const TextStyle(color: AppColors.teal, fontWeight: FontWeight.w600),
                    prefixIcon: const Icon(Icons.phone_rounded, color: AppColors.teal),
                    filled: true,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      // 1b. تحقق من رقم التليفون
                      final rawPhone = phoneCtrl.text.replaceAll(RegExp(r'\D'), '');
                      if (rawPhone.isEmpty || rawPhone.length < 10) {
                        ErrorHandler.showError(context, 'يرجى إدخال رقم تليفون صحيح (10 أرقام على الأقل)');
                        return;
                      }
                      // تحويل للصيغة الموحدة +20XXXXXXXXXX
                      String digits = rawPhone;
                      if (digits.startsWith('0')) digits = digits.substring(1);
                      if (digits.startsWith('20') && digits.length > 10) digits = digits.substring(2);
                      final normalizedPhone = '+20$digits';
